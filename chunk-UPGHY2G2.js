...
function S(t3, i5, s4 = t3, e4) {
  ...
  return h3?.constructor !== o5 && (h3?._$AO?.(false), void 0 === o5 ? h3 = void 0 : (h3 = new o5(t3), h3._$AT(t3, s4, e4)), void 0 !== e4 ? (s4._$Co ??= [])[e4] = h3 : s4._$Cl = h3), void 0 !== h3 && (i5 = S(t3, h3._$AS(t3, i5.values), h3, e4)), i5;
}
var M = class {
  constructor(t3, i5) {
...
var k = class {
  ...
  _$AI(t3, i5 = this, s4, e4) {
    ...
    if (void 0 === h3) t3 = S(this, t3, i5, 0), o5 = !c(t3) || t3 !== this._$AH && t3 !== T, o5 && (this._$AH = t3);
      ...
      const e5 = t3;
      let n4, r4;
      for (t3 = h3[0], n4 = 0; n4 < h3.length - 1; n4++) r4 = S(this, e5[s4 + n4], i5, n4), r4 === T && (r4 = this._$AH[n4]), o5 ||= !c(r4) || r4 !== this._$AH[n4], r4 === E ? t3 = E : t3 !== E && (t3 += (r4 ?? "") + h3[n4 + 1]), this._$AH[n4] = r4;
    }
    o5 && !e4 && this.j(t3);
  }
  j(t3) {
...
var y2 = class extends HTMLElement {
  ...
  requestUpdate(t3, s4, i5) {
    if (void 0 !== t3) {
      ...
      if (i5 ??= e4.getPropertyOptions(t3), !((i5.hasChanged ?? f2)(h3, s4) || i5.useDefault && i5.reflect && h3 === this._$Ej?.get(t3) && !this.hasAttribute(e4._$Eu(t3, i5)))) return;
      this.C(t3, s4, i5);
    }
